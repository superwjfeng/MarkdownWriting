...
* Bernoulli 分布/0-1分布：1 重伯努利试验 $p_k=p^k(1-p)^{1-k},\ k=0,1$
...
* 分类分布 Categorical Distribution 是伯努利分布的推广，它描述了单次试验中具有多个可能结果的随机变量的概率分布。伯努利分布处理的是二元（两种可能结果）的情况，而分类分布则适用于多类别的情况，也就是说，一个试验可以有两个以上的可能结果
* 泊松分布 $X\sim P(\lambda)$
