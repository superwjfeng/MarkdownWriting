...
- [**`Take`**](https://reactivex.io/documentation/operators/take.html) — emit only the first *n* items emitted by an Observable. 只取前n个数据项
- [**`TakeLast`**](https://reactivex.io/documentation/operators/takelast.html) — emit only the last *n* items emitted by an Observable. 只取后n个数据项
