...
* 必须是前序和中序或者中序和后序的序列和无重复值才能重建二叉树，**若是前序和后序则不能。也就是必须要有中序**，前序和后序确定树的根，而中序分割树的区间
    ...
    <img src="从前序与中序遍历序列构造二叉树.drawio.png" width="70%">
...
* [106. 从中序与后序遍历序列构造二叉树](https://leetcode.cn/problems/construct-binary-tree-from-inorder-and-postorder-traversal/)：用中序和后序重建二叉树的时候的注意点在于先构建右子树，再构建左子树，因为后序的遍历顺序为左、右、root
...
* [450. 删除二叉搜索树中的节点](https://leetcode.cn/problems/delete-node-in-a-bst/)：参考BST的Insert实现，可以考虑循环和递归两种写法
