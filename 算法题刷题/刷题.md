...
[155. 最小栈](https://leetcode.cn/problems/min-stack/)：构造一个辅助栈minst存储最小值，当st中有小于等于minst堆顶数据的时候minst才插入

<img src="最小栈.png" width="40%">

这里要考虑清楚的是 push 和 pop 两个接口，push 要 <= ？
